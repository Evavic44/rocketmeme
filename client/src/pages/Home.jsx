      ...
      <HomeCategory>
        ...
        <div className="homeCategory">
          <NavLink to="/categories" className="card">
            <figure className="lazyload title-one img-hover"></figure>
            <div className="tag">
              <h3>Technology</h3>
              <p>1100 posts</p>
            </div>
          ...
          <NavLink to="/categories" className="card">
            <figure className="lazyload title-two img-hover"></figure>
            <div className="tag">
              <h3>Comrade</h3>
              <p>200 posts</p>
            </div>
          ...
          <NavLink to="/categories" className="card">
            <figure className="lazyload title-three img-hover"></figure>
            <div className="tag">
              <h3>Pepe</h3>
              <p>930 posts</p>
            </div>
          ...
          <NavLink to="/categories" className="card">
            <figure className="lazyload title-four img-hover"></figure>
            <div className="tag">
              <h3>JavaScript</h3>
              <p>99 posts</p>
            </div>
          ...
          <NavLink to="/categories" className="card">
            <figure className="lazyload title-five img-hover"></figure>
            <div className="tag">
              <h3>NFT</h3>
              <p>181 posts</p>
            </div>
          ...
          <NavLink to="/categories" className="card">
            <figure className="lazyload title-six img-hover"></figure>
            <div className="tag">
              <h3>Stackoveflow</h3>
              <p>181 posts</p>
            </div>
          ...
          <NavLink to="/categories" className="card">
            <figure className="lazyload title-seven img-hover"></figure>
            <div className="tag">
              <h3>Coding</h3>
              <p>6200 posts</p>
            </div>
